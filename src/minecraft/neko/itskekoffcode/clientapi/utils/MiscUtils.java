        ...
        if (otherEntity != null) {
            for (final TextFormatting TextFormatting3 : net.minecraft.util.text.TextFormatting.values()) {
                if (TextFormatting3 != net.minecraft.util.text.TextFormatting.RESET) {
                    if (Minecraft.getInstance().player.getDisplayName().getFormattedText().contains(TextFormatting3.toString()) && TextFormatting == null) {
            ...
            try {
                ...
                } else if (Minecraft.getInstance().player.getTeam() != null) {
                    b = !Minecraft.getInstance().player.isOnSameTeam(otherEntity);
                } else if (Minecraft.getInstance().player.inventory.armorInventory.get(3).getItem() instanceof ItemBlock) {
                    b = !ItemStack.areItemStacksEqual(Minecraft.getInstance().player.inventory.armorInventory.get(3), otherEntity.inventory.armorInventory.get(3));
                }
