package neko.itskekoffcode.hclient.shader;
...
public abstract class Shader{
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/richclient/shaders/vertex.vert");
            vertexShaderID = createShader(IOUtils.toString(vertexStream), ARBVertexShader.GL_VERTEX_SHADER_ARB);
            IOUtils.closeQuietly(vertexStream);

            InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/richclient/shaders/fragment/" + fragmentShader);
