...
public class C00Handshake implements Packet<INetHandlerHandshakeServer>
{
    ...
    public C00Handshake(String p_i47613_1_, int p_i47613_2_, EnumConnectionState p_i47613_3_) {
        ...
        if (!HackPack.getFakeIp().isEmpty()) {
            StringBuilder var10001 = (new StringBuilder(p_i47613_1_)).append("\u0000");
            HClient.getHackPack();
            var10001 = var10001.append(HackPack.getFakeIp()).append("\u0000");
            HClient.getHackPack();
            this.ip = var10001.append(HackPack.getFakeUUID().replace("-", "")).toString();
        } else {
            this.ip = p_i47613_1_;
        }
