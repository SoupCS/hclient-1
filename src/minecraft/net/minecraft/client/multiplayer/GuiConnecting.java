...
public class GuiConnecting extends GuiScreen
{
    ...
    {
        GuiConnecting.ip = ip;
        GuiConnecting.port = Integer.valueOf(port);
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    GuiConnecting.LOGGER.error("Couldn't connection to server", unknownhostexception);
                ...
                catch (Exception exception)
                {
                    ...
                    GuiConnecting.LOGGER.error("Couldn't connection to server", exception);
