...
import neko.itskekoffcode.clientapi.event.event.EventKey;
import neko.itskekoffcode.clientapi.event.event.EventMouseKey;
...
import neko.itskekoffcode.hclient.font.FontUtil;
import neko.itskekoffcode.hclient.font.MCFontRenderer;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public String[] niggers = {"nigger_1.jpg", "nigger_2.jpg", "nigger_3.jpg", "nigger_4.jpg", "nigger_5.jpg", "nigger_6.jpg", "nigger_7.jpg",  "nigger_8.jpg", "nigger_9.jpg", "nigger_10.jpg", "nigger_11.jpg", "nigger_12.jpg", "nigger_13.jpg"};
    ...
    public MCFontRenderer neverlose;
    ...
    private final HClient hclient = new HClient();
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        this.launchedVersion = "HClient DEV";
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.neverlose500_20 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/neverlose500.ttf"), 20.0f, 0), true, true);
        this.sfui18 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/sf-ui.ttf"), 18.0f, 0), true, true);
        this.sfui25 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/sf-ui.ttf"), 25.0f, 0), true, true);
        this.neverlose900_15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/lato_regular.ttf"), 30.0f, 0), true, true);
        this.splash = new SplashScreen(Minecraft.getMinecraft(), true);
        this.splash.resetProgressAndMessage("");
        this.splash.setLoadingProgress(5, "Loading...");
        ...
        this.splash.setLoadingProgress(9, "Font loader");
        this.neverlose = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/neverlose500.ttf"), 14.0f, 0), true, true);
        this.neverlose500_15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/neverlose500.ttf"), 15.0f, 0), true, true);
        this.sfui16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("hclient/font/sf-ui.ttf"), 16.0f, 0), true, true);
        ...
        this.splash.setLoadingProgress(10, "Loading resources...");
        ...
        this.splash.setLoadingProgress(40, "Loading textures");
        this.textureMapBlocks = new TextureMap("textures");
        this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
        this.splash.setLoadingProgress(50, "Loading textures - 2");
        this.renderEngine.loadTickableTexture(TextureMap.LOCATION_BLOCKS_TEXTURE, this.textureMapBlocks);
        this.renderEngine.bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
        this.splash.setLoadingProgress(60, "Loading renders");
        ...
        this.splash.setLoadingProgress(70, "Loading global renders");
        ...
        this.splash.setLoadingProgress(80, "Finishing...");
        this.func_193986_ar();
        ...
        this.splash.setLoadingProgress(90, "HClient instance...");
        HClient.getInstance().load();
        this.splash.setLoadingProgress(100, "done");
        ThreadUtils.sleep(650L);
        ...
        this.loadingScreen.setDoneWorking();
    }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft 1.12.2 | HClient loading");
    ...
    private void runTickKeyboard() throws Exception {
        while (Keyboard.next()) {
    ...
    private boolean processKeyF3(int p_184122_1_) throws Exception {
        if (p_184122_1_ == 30)
        {
            this.renderGlobal.loadRenderers();
    ...
    private void runTickMouse() throws Exception {
        while (Mouse.next()) {
