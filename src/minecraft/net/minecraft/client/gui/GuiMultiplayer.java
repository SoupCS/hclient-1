...
import neko.itskekoffcode.hclient.alt.gui.AltManager;
import neko.itskekoffcode.hclient.gui.GuiHackTools;
import neko.itskekoffcode.hclient.gui.multiplayer.IGuiMultiplayer;
...
public class GuiMultiplayer extends GuiScreen implements IGuiMultiplayer {
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(100, width / 2 + 160, height - 52, 75, 20, I18n.format("Tools")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 8)
            {
                ...
                this.mc.displayGuiScreen(new MonitoringParser(this.parentScreen));
            }
            else if (button.id == 100) {
                this.mc.displayGuiScreen(new GuiHackTools(this.parentScreen));
            } else if (button.id == 69) {
                this.mc.displayGuiScreen(new GuiProtocolSelector(this.parentScreen));
            }
        }
    }
