...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    {
        if (this.inputField.getText().startsWith(CommandManager.syntax) || this.inputField.getText().startsWith(CommandManager.botsyntax)) {
            GL11.glEnable(GL11.GL_BLEND);
            DrawHelper.drawBorderedRect(2, height - 14, width - 2, height - 1, 1, new Color(50, 145, 255, 255).getRGB(), Integer.MIN_VALUE);
            this.inputField.drawTextBox();

            drawString(fontRendererObj, String.format("%d/%d", this.inputField.getText().length(), this.inputField.getMaxStringLength()), 4, height - 22, new Color(36, 224, 213, 255).getRGB());
            ...
            DrawHelper.drawRect(2, height - 14, width - 1, height - 2, Integer.MIN_VALUE);
            this.inputField.drawTextBox();
