...
public class GuiWDLMultiworld extends GuiScreen {
	...
	public void initGui() {
		...
		infoBoxX = width / 2 - infoBoxWidth / 2;
		infoBoxY = height / 2 - infoBoxHeight / 2;
		
		this.multiworldEnabledBtn = new GuiButton(1, width / 2 - 100,
				infoBoxY + infoBoxHeight - 30, 
				this.getMultiworldEnabledText());
		this.buttonList.add(this.multiworldEnabledBtn);
		
		this.buttonList.add(new GuiButton(100, width / 2 - 155,
				height - 29, 150, 20, I18n.format("gui.cancel")));
		
		this.buttonList.add(new GuiButton(101, width / 2 + 5,
				height - 29, 150, 20, I18n.format("gui.done")));
	}
