...
public class GuiWDLEntityRangePresets extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		this.vanillaButton = new GuiButton(0, width / 2 - 100, y,
				I18n.format("wdl.gui.rangePresets.vanilla"));
		y += 22;
		this.spigotButton = new GuiButton(1, width / 2 - 100, y,
				I18n.format("wdl.gui.rangePresets.spigot"));
		y += 22;
		this.serverButton = new GuiButton(2, width / 2 - 100, y,
		...
		this.cancelButton = new GuiButton(100, width / 2 - 100,
				height - 29, I18n.format("gui.cancel"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj,
				I18n.format("wdl.gui.rangePresets.title"), width / 2, 8,
				0xFFFFFF);
