...
public class GuiWDLBackup extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(0, width / 2 - 100, 32,
				getBackupButtonText()));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj,
				I18n.format("wdl.gui.backup.title"), width / 2, 8,
				0xFFFFFF);
		
		super.drawScreen(mouseX, mouseY, partialTicks);
		
		Utils.drawGuiInfoBox(description, width - 50, 3 * height / 5, width,
				height, 48);
	}
}
