...
public class GuiWDLGenerator extends GuiScreen {
	...
	public void initGui() {
		...
		this.seedField = new GuiTextField(40, this.fontRendererObj,
				width / 2 - (100 - seedWidth), y, 200 - seedWidth, 18);
		this.seedField.setText(WDL.worldProps.getProperty("RandomSeed"));
		y += 22;
		this.generatorBtn = new GuiButton(1, width / 2 - 100, y,
				getGeneratorText());
		this.buttonList.add(this.generatorBtn);
		y += 22;
		this.generateStructuresBtn = new GuiButton(2, width / 2 - 100, y,
				getGenerateStructuresText());
		this.buttonList.add(this.generateStructuresBtn);
		y += 22;
		this.settingsPageBtn = new GuiButton(3, width / 2 - 100, y,
				"");
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(this.fontRendererObj, seedText, width / 2 - 100,
