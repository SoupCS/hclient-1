...
public class GuiWDLMultiworldSelect extends GuiTurningCameraBase {
	private class WorldGuiButton extends GuiButton {
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY, float a) {
			...
			super.drawButton(mc, mouseX, mouseY, a);
		}
	...
	public void initGui() {
		...
		this.cancelBtn = new GuiButton(-1, width / 2 - 155, height - 25,
				150, 20, I18n.format("gui.cancel"));
		this.buttonList.add(this.cancelBtn);
		
		this.acceptBtn = new GuiButton(-2, width / 2 + 5, height - 25,
		...
		prevButton = new GuiButton(-4, width / 2 - offset, y, 20, 20, "<");
		this.buttonList.add(prevButton);
		
		for (int i = 0; i < numWorldButtons; i++) {
			this.buttonList.add(new WorldGuiButton(i, width / 2 - offset
					+ i * 155 + 25, y, 150, 20));
		}
		
		nextButton = new GuiButton(-5, width / 2 - offset + 25
				+ numWorldButtons * 155, y, 20, 20, ">");
		this.buttonList.add(nextButton);
		
		this.newWorldButton = new GuiButton(-3, width / 2 - 155, 29, 150, 20,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, title, width / 2, 8,
				0xFFFFFF);
