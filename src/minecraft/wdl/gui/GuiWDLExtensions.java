...
public class GuiWDLExtensions extends GuiScreen {
	...
	private class ModList extends GuiListExtended {
		public ModList() {
			super(GuiWDLExtensions.this.mc, GuiScreen.width,
		...
		private class ModEntry implements IGuiListEntry {
			...
			public void func_192634_a(int slotIndex, int x, int y, int listWidth,
				...
				if (button != null) {
					button.xPosition = GuiScreen.width - 180;
					button.yPosition = y - 1;
					
					button.drawButton(mc, mouseX, mouseY, partialTicks);
				}
				
				disableButton.xPosition = GuiScreen.width - 92;
				disableButton.yPosition = y - 1;
				disableButton.drawButton(mc, mouseX, mouseY, partialTicks);
		...
		public int getListWidth() {
			return GuiScreen.width - 20;
		}
		
		@Override
		protected int getScrollBarX() {
			return GuiScreen.width - 10;
		}
	...
	private class ModDetailList extends TextList {
		public ModDetailList() {
			super(GuiWDLExtensions.this.mc, GuiScreen.width,
					GuiScreen.height - bottomLocation,
		...
		public void drawScreen(int mouseX, int mouseY, float partialTicks) {
			...
			this.height = GuiScreen.height - bottomLocation;
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj,
				I18n.format("wdl.gui.extensions.title"), width / 2, 8,
				0xFFFFFF);
