...
public class GuiWDLPermissions extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(200, width / 2 - 155, 39, 100, 20,
				I18n.format("wdl.gui.permissions.current")));
		if (WDLPluginChannels.canRequestPermissions()) {
			this.buttonList.add(new GuiButton(201, width / 2 - 50, 39, 100, 20,
					I18n.format("wdl.gui.permissions.request")));
			this.buttonList.add(new GuiButton(202, width / 2 + 55, 39, 100, 20,
					I18n.format("wdl.gui.permissions.overrides")));
		}
		
		reloadButton = new GuiButton(1, (width / 2) + 5, 18, 150, 20,
				"Reload permissions");
