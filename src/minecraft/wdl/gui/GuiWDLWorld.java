...
public class GuiWDLWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.gamemodeBtn = new GuiButton(1, width / 2 - 100, y,
				this.getGamemodeText());
		this.buttonList.add(this.gamemodeBtn);
		y += 22;
		this.allowCheatsBtn = new GuiButton(6, width / 2 - 100, y,
				this.getAllowCheatsText());
		this.buttonList.add(this.allowCheatsBtn);
		y += 22;
		this.timeBtn = new GuiButton(2, width / 2 - 100, y,
				this.getTimeText());
		this.buttonList.add(this.timeBtn);
		y += 22;
		this.weatherBtn = new GuiButton(3, width / 2 - 100, y,
				this.getWeatherText());
		this.buttonList.add(this.weatherBtn);
		y += 22;
		this.spawnBtn = new GuiButton(4, width / 2 - 100, y,
				this.getSpawnText());
		this.buttonList.add(this.spawnBtn);
		y += 22;
		this.spawnTextY = y + 4;
		this.spawnX = new GuiNumericTextField(40, this.fontRendererObj, width / 2 - 87,
				y, 50, 16);
		this.spawnY = new GuiNumericTextField(41, this.fontRendererObj, width / 2 - 19,
				y, 50, 16);
		this.spawnZ = new GuiNumericTextField(42, this.fontRendererObj, width / 2 + 48,
				y, 50, 16);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.showSpawnFields) {
			this.drawString(this.fontRendererObj, "X:", width / 2 - 99,
					this.spawnTextY, 0xFFFFFF);
			this.drawString(this.fontRendererObj, "Y:", width / 2 - 31,
					this.spawnTextY, 0xFFFFFF);
			this.drawString(this.fontRendererObj, "Z:", width / 2 + 37,
					this.spawnTextY, 0xFFFFFF);
