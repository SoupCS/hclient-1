...
public class GuiWDLUpdates extends GuiScreen {
	...
	private class UpdateList extends GuiListExtended {
		public UpdateList() {
			super(GuiWDLUpdates.this.mc, GuiScreen.width,
                    GuiScreen.height, TOP_MARGIN,
					GuiScreen.height - BOTTOM_MARGIN,
	...
	public void initGui() {
		...
		this.updateAllowBetasButton = new GuiButton(1,
				width / 2 + 5, 18, 150, 20, getAllowBetasText());
	...
	private class GuiWDLSingleUpdate extends GuiScreen {
		...
		@Override
		public void initGui() {
			this.buttonList.add(new GuiButton(0, width / 2 - 155,
					18, 150, 20, I18n.format("wdl.gui.updates.update.viewOnline")));
			if (release.hiddenInfo != null) {
				this.buttonList.add(new GuiButton(1, width / 2 + 5,
