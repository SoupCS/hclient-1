...
public class GuiWDLPlayer extends GuiScreen {
	...
	public void initGui() {
		...
		int y = height / 4 - 15;
		this.healthBtn = new GuiButton(1, width / 2 - 100, y, getHealthText());
		this.buttonList.add(this.healthBtn);
		y += 22;
		this.hungerBtn = new GuiButton(2, width / 2 - 100, y, getHungerText());
		this.buttonList.add(this.hungerBtn);
		y += 22;
		this.playerPosBtn = new GuiButton(3, width / 2 - 100, y,
				getPlayerPosText());
		...
		y += 18;
		this.pickPosBtn = new GuiButton(4, width / 2 - 0, y, 100, 20,
