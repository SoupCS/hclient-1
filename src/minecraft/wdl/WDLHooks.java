...
public class WDLHooks {
	...
	public static void onNHPCHandleChat(NetHandlerPlayClient sender,
		...
		try {
			...
			//getChatComponent returns the ITextComponent.
	...
	public static void injectWDLButtons(GuiIngameMenu gui, List buttonList) {
		...
		// Insert wdl buttons.
		GuiButton wdlDownload = new GuiButton(WDLs, GuiScreen.width / 2 - 100,
				insertAtYPos, 168, 20, null);
		
		GuiButton wdlOptions = new GuiButton(WDLo, GuiScreen.width / 2 + 72,
				insertAtYPos, 28, 20,
